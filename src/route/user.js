...
router.get('/user-list', function (req, res) {
  ...
  res.render('user-list', {
    ...
    title: 'Сторінка списку користувачів',
...
router.get('/user-item', function (req, res) {
  ...
  res.render('user-item', {
    ...
    // вказуємо назву сторінки
    title: 'Сторінка елемента користувача',
    // ... сюди можна далі продовжувати додавати потрібні технічні дані, які будуть використовуватися в layout
...
router.get('/user-item-data', function (req, res) {
  ...
  if (!id) {
    return res.status(400).json({
      message: 'Ідентифікатор користувача відсутній',
    })
  }
  ...
  if (!user) {
    return res.status(400).json({
      message: 'Користувача з таким ідентифікатором не існує',
    })
  }
